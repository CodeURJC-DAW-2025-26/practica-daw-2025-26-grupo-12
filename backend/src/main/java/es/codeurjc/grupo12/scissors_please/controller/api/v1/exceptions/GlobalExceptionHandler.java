...
public class GlobalExceptionHandler {
  ...
  public ResponseDto handleInvalidFormat(HttpMessageNotReadableException ex) {
    return new ResponseDto(
        true, ResponseConstants.BAD_REQUEST_CODE_INT, "Formato de request inválido");
  }
  ...
  public ResponseDto handleImageUploadException(Exception ex) {
    return new ResponseDto(
        true, ResponseConstants.BAD_REQUEST_CODE_INT, ResponseConstants.IMAGE_ERROR_UPLOAD);
  }
}

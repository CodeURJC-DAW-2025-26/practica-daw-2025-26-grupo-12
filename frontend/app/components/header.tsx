                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav me-auto">
                            ...
                            {admin && <>
                                <li className="nav-item"><Link className="nav-link" to="/admin/tournaments">Tournaments</Link></li>
                        ...
                        <div className="d-flex gap-2 align-items-center">
                            ...
                            {logged && !admin && <Link to="/user/profile" className="btn btn-outline-muted btn-sm px-3">Profile</Link>}

    ...
    <Container className="py-5 mt-5">
              ...
              <Row className="g-3">
                <Col md={7}>
                  <Form.Group controlId="name">
                    <Form.Label className="text-uppercase small">Bot Name</Form.Label>
                    <Form.Control
                      size="lg"
                      type="text"
                ...
                <Col md={5}>
                  <Form.Group controlId="isPublic">
                    <Form.Label className="text-uppercase small">Visibility</Form.Label>
                    <Form.Select 
                      size="lg" 
                ...
                <Col xs={12}>
                  <Form.Group controlId="tags">
                    <Form.Label className="text-uppercase small">Tags</Form.Label>
                    <Form.Control
                      size="lg"
                      type="text"
                      ...
                      onChange={handleInputChange}
                    />
                    <Form.Text className="text-secondary">Example: aggressive, random, counter</Form.Text>
                  </Form.Group>
                </Col>
                <Col xs={12}>
                ...
                <Col xs={12}>
                  <Form.Group controlId="code">
                    <Form.Label className="text-uppercase small">Bot Code (Logic)</Form.Label>
                    <Form.Control
                      as="textarea"
                      rows={8}
                      size="lg"
                ...
                <Col xs={12}>
                  <Form.Label className="text-uppercase small">Bot Image</Form.Label>
                  <div className="d-flex flex-wrap gap-3">
                    ...
                    <div className="d-flex flex-column justify-content-center">
                      <div className="d-flex gap-2">
                        ...
                        {imageFile && <span className="text-info small align-self-center">Selected: {imageFile.name}</span>}
                      </div>
                      <span className="text-secondary small mt-1">PNG, JPG up to 10MB.</span>
                    </div>
                  </div>
                </Col>
        ...
        <Col lg={4}>
          <Card className="p-4 mb-4 shadow-sm">
            ...
            <ListGroup variant="flush">
              <ListGroup.Item className="bg-transparent px-0 border-secondary">Keep code deterministic and safe.</ListGroup.Item>
              <ListGroup.Item className="bg-transparent px-0 border-secondary">Avoid external network calls.</ListGroup.Item>
              <ListGroup.Item className="bg-transparent px-0 border-secondary">Test locally before uploading.</ListGroup.Item>
            </ListGroup>
          </Card>
        </Col>
      </Row>
      ...
      <Modal show={showImageModal} onHide={() => setShowImageModal(false)} centered>
        ...
        <Modal.Footer className="border-secondary bg-dark">
          <Button variant="outline-secondary" onClick={() => setShowImageModal(false)}>Cancel</Button>
          <Button variant="primary" onClick={confirmImage} disabled={!tempFile}>Confirm</Button>
        </Modal.Footer>
      </Modal>
    </Container>
  );
